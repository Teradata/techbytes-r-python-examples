...
--------------------------------------------------------------------------------
README-R_Py_TechBytes-Part_3:
README file for Part 3 of the R and Python TechBytes Demo
...
2. R and Python TechBytes Demo - Part 3 Information
--------------------------------------------------------------------------------

The present Part 3 of the demo is a bundle with the following files:
...
The present Part 3 guides the user through data manipulation and transformation
(Section 1 of the demo), model fitting, and model scoring tasks (Section 2 of
the demo) by using the Teradata Python package teradataml for clients.
...
- The data manipulation and transformation tasks are operations that are
  initiated through Python on the client, and executed in the Advanced SQL
  Engine database of the target Vantage system.
- The model fitting and scoring tasks are also initiated through Python on the
...
Note: To perform the model fitting and scoring tasks in Section 2 of this
      ...
      tasks can be still performed by means of suitable Python add-on libraries
      on the client and by moving the necessary data from Vantage to the client.
      However, the latter approach is outside the scope of the present demo.


3. How to run Part 3 of the "R and Python TechBytes Demo"
--------------------------------------------------------------------------------
...
"R_Py_TechBytes-Part_3-Demo.py". In case you work with Jupyter Notebooks,
use directly the notebook file "R_Py_TechBytes-Part_3-Demo.ipynb" that has
identical code with "R_Py_TechBytes-Part_3-Demo.py".

Follow the step-by-step instructions in the files and adjust the code where
indicated to provide credentials, file paths, or desired names as prompted
by the comments. The code provides a hands-on experience of using the Teradata
Python package teradataml. All files contains ample comments and notes that
explain each step of the process.

Note: Depending on the Python interpreter installation on your client, you
      may need to install the add-on libraries used by the code; namely,
      "teradataml", "sqlalchemy", "matplotlib", "pandas", and "numpy".
